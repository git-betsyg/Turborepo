...
import {
  ...
  AppKitNetwork,
  solana,
  solanaTestnet, solanaDevnet, bitcoin
...
// Create wagmiConfig
export const chains: [AppKitNetwork, ...AppKitNetwork[]] = [mainnet, optimism, arbitrum, sepolia, solana, solanaTestnet, solanaDevnet,bitcoin];
